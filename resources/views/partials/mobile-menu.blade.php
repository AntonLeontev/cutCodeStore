	...
	<div class="container">
		<div class="flex items-center pt-6 mmenu-heading xl:pt-12">
			<div class="shrink-0 grow">
				<a href="index.html" rel="home">
					<img src="/logo-dark.svg" class="w-[148px] md:w-[201px] h-[36px] md:h-[50px]" alt="CutCode">
				</a>
			</div>
		...
		<div class="pt-10 mmenu-inner">
					...
					<div class="flex flex-col items-start ml-4">
						...
						<div class="inline-flex items-center cursor-pointer text-dark hover:text-pink">
							...
							<form action="{{route('logout')}}" method="POST">
								@csrf
								@method('DELETE')
								<input class="ml-[6px] font-medium" type="submit" value="Выйти">
							</form>
						</div>
					</div>
				</div>
			...
			<nav class="flex flex-col mt-8">
				...
				<a href="{{route('catalog')}}" class="self-start py-1 font-bold text-dark hover:text-pink text-md">Каталог товаров</a>
