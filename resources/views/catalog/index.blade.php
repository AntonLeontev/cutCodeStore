        ...
        <div class="flex flex-col gap-12 mt-8 lg:flex-row lg:gap-6 2xl:gap-8">
            ...
            <aside class="basis-2/5 xl:basis-1/4">
                <form action="{{ route('catalog', $activeCategory) }}" class="overflow-auto max-h-[320px] lg:max-h-[100%] space-y-10 p-6 2xl:p-8 rounded-2xl bg-card">
                    <!-- Filter item -->
                    <div>
                        <h5 class="mb-4 text-sm font-bold 2xl:text-md">Цена</h5>
                    ...
                    <!-- Filter item -->
                    <div>
                        <h5 class="mb-4 text-sm font-bold 2xl:text-md">Бренд</h5>
            ...
            <div class="basis-auto xl:basis-3/4">
                ...
                <div class="flex flex-col justify-between gap-4 mb-8 md:flex-row md:items-center">
                    <div class="flex items-center gap-4">
                        <div class="flex items-center gap-2">
                            <a href="#" class="inline-flex items-center justify-center w-10 h-10 rounded-md pointer-events-none bg-card text-pink">
                            ...
                            <a href="#" class="inline-flex items-center justify-center w-10 h-10 text-white rounded-md bg-card hover:text-pink">
                                <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 52 52">
                ...
                <!-- Products list -->
                <div class="grid grid-cols-1 products sm:grid-cols-2 xl:grid-cols-3 gap-x-6 2xl:gap-x-8 gap-y-8 lg:gap-y-10 2xl:gap-y-12">
