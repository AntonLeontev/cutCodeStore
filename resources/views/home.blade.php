...
@section('content')
    <section>
        ...
        <div class="grid grid-cols-1 gap-3 mt-8 sm:grid-cols-2 2xl:grid-cols-4 sm:gap-4 md:gap-6">
            <div
                ...
                <svg class="w-10 h-10 md:w-12 md:h-12 opacity-40" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                    viewBox="0 0 18 18">
                ...
                <h5 class="pt-2 text-sm font-bold md:pt-4 md:text-md">Бесплатная доставка</h5>
            ...
            <div
                ...
                <h5 class="pt-2 text-sm font-bold md:pt-4 md:text-md">Безопасный шопинг</h5>
            ...
            <div
                ...
                <h5 class="pt-2 text-sm font-bold md:pt-4 md:text-md">Работаем для клиента</h5>
            ...
            <div
                ...
                <h5 class="pt-2 text-sm font-bold md:pt-4 md:text-md">Поддержка</h5>
    ...
    <section class="mt-16 lg:mt-24">
        ...
        <!-- Products list -->
        <div
            class="grid grid-cols-1 mt-8 products sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-x-8 gap-y-8 lg:gap-y-10 2xl:gap-y-12">
    ...
    <section class="mt-20">
        ...
        <!-- Brands list -->
        <div class="grid grid-cols-2 gap-4 mt-12 md:grid-cols-3 2xl:grid-cols-6 md:gap-8">
